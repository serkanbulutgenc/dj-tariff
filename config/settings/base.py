...
LOCAL_APPS = [
    ...
    "apps.tariffs.apps.TariffConfig",
...
MIGRATION_MODULES = {"sites": "dj_tariff.contrib.sites.migrations"}
...
ADMINS = ['"Serkan" <serkanbulutgenc@gmail.com>']
